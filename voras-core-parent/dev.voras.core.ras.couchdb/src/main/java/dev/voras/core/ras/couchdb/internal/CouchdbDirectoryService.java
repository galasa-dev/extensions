...
import dev.voras.core.ras.couchdb.internal.pojos.Row;
...
import dev.voras.core.ras.couchdb.internal.pojos.ViewResponse;
import dev.voras.core.ras.couchdb.internal.pojos.ViewRow;
...
public class CouchdbDirectoryService implements IResultArchiveStoreDirectoryService {
	...
	public @NotNull List<IRunResult> getRuns(@NotNull String runName) throws ResultArchiveStoreException {
		...
		HttpPost httpPost = new HttpPost(store.getCouchdbUri() + "/cirillo_run/_find");
		Find find = new Find();
	...
	private Path getRunArtifactPath(TestStructureCouchdb ts) throws CouchdbRasException {
		...
		for(String artifactRecordId : ts.getArtifactRecordIds()) {
			HttpGet httpGet = new HttpGet(store.getCouchdbUri()+ "/cirillo_artifacts/" + artifactRecordId);
	...
	private @NotNull List<IRunResult> getAllRuns() throws ResultArchiveStoreException {
		...
		HttpGet httpGet = new HttpGet(store.getCouchdbUri() + "/cirillo_run/_all_docs");
		httpGet.addHeader("Accept", "application/json");
	...
	private CouchdbRunResult fetchRun(String id) throws ParseException, IOException, CouchdbRasException {
		HttpGet httpGet = new HttpGet(store.getCouchdbUri() + "/cirillo_run/" + id);
		httpGet.addHeader("Accept", "application/json");
	...
	public @NotNull List<String> getRequestors() throws ResultArchiveStoreException {
		...
		HttpGet httpGet = new HttpGet(store.getCouchdbUri() + "/cirillo_run/_design/docs/_view/requestors-view?group=true");
		httpGet.addHeader("Accept", "application/json");
	...
	public @NotNull List<String> getTests() throws ResultArchiveStoreException {
		...
		HttpGet httpGet = new HttpGet(store.getCouchdbUri() + "/cirillo_run/_design/docs/_view/testnames-view?group=true");
		httpGet.addHeader("Accept", "application/json");
