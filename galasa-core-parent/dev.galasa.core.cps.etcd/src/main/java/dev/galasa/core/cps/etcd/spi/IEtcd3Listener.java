...
/**
 * <p>Provides a callback to listen for changes to a key, be it update or delete.</p>
 * 
 * <p>Register a listener with {@link IEtcd3Client#registerWatch(IEtcd3Listener, String)}</p>
 *  
