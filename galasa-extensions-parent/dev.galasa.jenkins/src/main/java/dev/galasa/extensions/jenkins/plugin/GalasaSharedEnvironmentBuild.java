...
public class GalasaSharedEnvironmentBuild extends Builder implements SimpleBuildStep {
    ...
    public GalasaSharedEnvironmentBuild(String test, String stream, String[] envProps) {
        this.test = test;
        this.stream = stream;
    ...
    public void perform(Run<?, ?> run, FilePath workspace, Launcher launcher, TaskListener listener)
        ...
        logger.println("************************************************************");
        logger.println("** Build Galasa Shared Environment                       ***");
        logger.println("************************************************************");
        ...
        if (!"up".equalsIgnoreCase(runResult.getStatus())) {
            logger.println("Shared Environment Build failed - " + runResult.getName());
            run.setResult(Result.FAILURE);
        }
        
        logger.println("Shared Environment build suceeded - " + runResult.getName());
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Builder> {
        ...
        public String getDisplayName() {
            return "Galasa - Build Shared Environment";
        }
    }
    ...
    private String submitTestToSchedule(String test, 
        ...
        request.setSharedEnvironmentPhase("BUILD");
