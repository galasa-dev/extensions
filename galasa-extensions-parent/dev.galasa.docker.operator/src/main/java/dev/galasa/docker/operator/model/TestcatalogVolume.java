...
public class TestcatalogVolume extends AbstractResource {

    private static final String RESOURCE_NAME = "galasa_testcatalog_volume";

    public TestcatalogVolume(Ecosystem ecosystem) {
        super(ecosystem);
    }
    ...
    public void checkResourceDefined() throws DockerOperatorException {
        ...
        try {
            ...
            System.out.println("Testcatalog Volume is missing");
        } catch(Exception e) {
            throw new DockerOperatorException("Problem inspecting the Testcatalog volume resource", e);
        }
        ...
        try {
            ...
            createCommand.exec();
            System.out.println("Testcatalog volume created");
        } catch(Exception e) {
            throw new DockerOperatorException("Problem creating the Testcatalog volume", e);
        }
    }
