package dev.galasa.core.cps.etcd.spi;
...
/**
 * <p>The etcd3 client provides limited abstracted access to the official etcd3 client.  It is abstracted
 * to isolate the managers from changes to the official client, or to swap to a better one.</p>
 * 
 * <p>Leasing is not currently supported as there may not be the demand</p>
 * 
 * <p>An implementation of the client can be obtained via the {@Link IEtcd3ClientService} service.
 * 
...
public interface IEtcd3Client {
	...
	/**
	 * Store multiple key/value pairs in the server.  The keys may be prefiex by the client.
	 * 
	 ...
	 * @throws Etcd3ClientException
	 */
	boolean putSwap(@NotNull String key, String oldValue, @NotNull String newValue, @NotNull Map<String, String> others) throws Etcd3ClientException;
	 ...
	 * 
	 * @param keyPrefix - the prefix of all the keys to use.  This prefix may also be prefixed by the client
	 * @return
	 * @throws Etcd3ClientException
	 */
	@NotNull Map<String, String> getPrefix(@NotNull String keyPrefix) throws Etcd3ClientException;
	 ...
	 * 
	 * @param keys - all the keys that need to be deleted,  may be prefixed by the client
	 * @throws Etcd3ClientException
	 */
	...
	/**
	 * Register a watch on a key/value pair.   A UUID is returned to represent this specific watch, so can be unregistered
	 * in the future.
	 * 
