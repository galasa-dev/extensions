...
# The galasa-extensions-parent/dev.galasa.ras.couchdb/build.gradle file is where the version number 
# of the framework component lives.

cat $BASEDIR/galasa-extensions-parent/dev.galasa.ras.couchdb/build.gradle | sed "s/^[ ]*dev.galasa.framework:[ ]*=.*/dev.galasa.framework: = \"$component_version\"/1" > $temp_dir/framework-build.gradle
cp $temp_dir/framework-build.gradle $BASEDIR/galasa-extensions-parent/dev.galasa.ras.couchdb/build.gradle
