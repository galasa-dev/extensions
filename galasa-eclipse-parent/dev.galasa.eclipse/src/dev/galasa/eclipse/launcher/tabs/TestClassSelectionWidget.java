...
public class TestClassSelectionWidget {
	 ...
	 * 
	 * <p>
	 * By default disabled, but may contain name of a specific test method to
	 * run
	 * </p>
	 */
	 ...
	 * @param style
	 */
	public TestClassSelectionWidget(IRunnableContext context, Composite parent,
			int style) {
	...
	private String chooseMethodName(Set<String> methodNames) {
		...
		dialog.setMessage("Select test method from test class "
				+ classText.getText());
	...
	private void handleClassSearchButtonSelected() {
		...
		for (IType type : types) {
			typeLookup.add(type.getPackageFragment().getElementName() + '/'
		...
		try {
			...
			dialog = JavaUI.createTypeDialog(shell, context, SearchEngine
				...
				public ITypeInfoFilterExtension getFilterExtension() {
					return new ITypeInfoFilterExtension() {
						...
						public boolean select(
								ITypeInfoRequestor requestor) {
							StringBuffer buf = new StringBuffer();
							buf.append(requestor.getPackageName())
							.append('/');
							String enclosingName = requestor
									.getEnclosingName();
	 ...
	 * 
	 * @return <p>fully qualified class name, a '#' character and the name of the method
	 */
