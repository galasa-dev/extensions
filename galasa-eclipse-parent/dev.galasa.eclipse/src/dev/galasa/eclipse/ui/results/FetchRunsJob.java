...
public class FetchRunsJob extends Job {
	...
	public FetchRunsJob(String requestor, String testClass, Instant from, Instant to, IResultArchiveStoreDirectoryService dirService, IRunResultsListener listener) {
		super("Fetch Runs");
