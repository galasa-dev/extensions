...
public class BranchSelectedRuns extends BranchFolder implements IRunResultsListener, IRefreshable {
	...
	protected BranchSelectedRuns(ResultsView view, IResultArchiveStoreDirectoryService dirService, String folderName, String requestor, String testClass, DateRange dateRange) {
