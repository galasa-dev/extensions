...
/**
 * Displays a view with all the run in the Galasa ecosystem, both automated and local
 * 
 * The RunsParent will run a job to retrieve all current jobs.  It will also watch for updates to runs.
