...
public class GeneralPage extends FormPage {
	...
	private void createOverview(FormToolkit toolkit, Composite body) {
		...
		Text textRunName = toolkit.createText(overviewComposite, this.testStructure.getRunName() , SWT.SINGLE | SWT.READ_ONLY);
		textRunName.setLayoutData(gd);

		toolkit.createLabel(overviewComposite, "Status:");
		Text textStatus = toolkit.createText(overviewComposite, this.testStructure.getStatus() , SWT.SINGLE | SWT.READ_ONLY);
		textStatus.setLayoutData(gd);

		toolkit.createLabel(overviewComposite, "Result:");
		Text textResult = toolkit.createText(overviewComposite, this.testStructure.getResult() , SWT.SINGLE | SWT.READ_ONLY);
		textResult.setLayoutData(gd);

		toolkit.createLabel(overviewComposite, "Requestor:");
		Text textRequestor = toolkit.createText(overviewComposite, this.testStructure.getRequestor() , SWT.SINGLE | SWT.READ_ONLY);
		textRequestor.setLayoutData(gd);

		if (this.testStructure.getBundle() != null) {
			toolkit.createLabel(overviewComposite, "Bundle:");
			Text textBundle = toolkit.createText(overviewComposite, this.testStructure.getBundle() , SWT.SINGLE | SWT.READ_ONLY);
			textBundle.setLayoutData(gd);
		}

		if (this.testStructure.getTestName() != null) {
			toolkit.createLabel(overviewComposite, "Test Name:");
			Text textTestName = toolkit.createText(overviewComposite, this.testStructure.getTestName() , SWT.SINGLE | SWT.READ_ONLY);
			textTestName.setLayoutData(gd);
		}

		if (this.testStructure.getQueued() != null) {
			toolkit.createLabel(overviewComposite, "Queued:");
			Text textQueued = toolkit.createText(overviewComposite, DateConverter.visualDate(this.testStructure.getQueued()) , SWT.SINGLE | SWT.READ_ONLY);
			textQueued.setLayoutData(gd);
		}
		if (this.testStructure.getStartTime() != null) {
			toolkit.createLabel(overviewComposite, "Started:");
			Text textQueued = toolkit.createText(overviewComposite, DateConverter.visualDate(this.testStructure.getStartTime()) , SWT.SINGLE | SWT.READ_ONLY);
			textQueued.setLayoutData(gd);
		}
		if (this.testStructure.getEndTime() != null) {
			toolkit.createLabel(overviewComposite, "Finished:");
			Text textQueued = toolkit.createText(overviewComposite, DateConverter.visualDate(this.testStructure.getEndTime()) , SWT.SINGLE | SWT.READ_ONLY);
			textQueued.setLayoutData(gd);
		}
	...
	private void createMethodSummary(FormToolkit toolkit, Composite body) {
		...
		MethodSummaryComposite compositeMethods = new MethodSummaryComposite(runEditor.getToolkit(), sectionMethods, this.testStructure, this);
